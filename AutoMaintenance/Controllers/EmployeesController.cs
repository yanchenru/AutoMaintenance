...
namespace AutoMaintenance.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,LastName,FirstMidName,HireDate")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID,LastName,FirstMidName,HireDate")] Employee employee)
        {
            if (ModelState.IsValid)
            {
